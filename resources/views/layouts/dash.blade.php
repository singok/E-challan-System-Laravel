                            ...
                            <div class="dropdown-item preview-item">
                                ...
                                <div class="preview-item-content">
                                    ...
                                    <p class="font-weight-light small-text mb-0 text-muted">
                                        Having driving license no. <span style="font-weight:bold;">{{ $notification->data['driving_license'] }}</span> has paid fine amount of <span style="font-weight:bold">Rs.{{ $notification->data['amount_paid'] }}</span> on <span style="font-weight:bold">{{ $notification->data['paid_at'] }}</span>.
                                    </p>
                                </div>
                            </div>
                        @endforeach
